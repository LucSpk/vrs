...
23-02-2026: Depois de um bom esforço consegui entender mais ou menos o funcionamento do malloc e do realloc, pelo menos entender o suficiente para finalizar a função de leitura dos arquivos do diretório. Ainda não entendo exatamente a função do free, mas cheguei a finalizar o código e imprimir todo através da main. Estou começando a rumar em direção do função que vai identificar o conteudo dos arquivos, mas antes, preciso ver algo sobre o array que memória dinamica, se ele é um problema para o meu projeto e vou precisar migrar os itens para um array estático, ou se é algo que eu posso usar sem medo.